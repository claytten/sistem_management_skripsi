...
<head>
    ...
    <title>Management List TA Mahasiswa</title>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Management List Tugas Akhir Mahasiswa</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="x_panel">
                      <div class="x_content" id="app">
                        <table id="datatable-responsive" class="example table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          ...
                          <tbody>
                              <?php
                              $query = "SELECT ta.id_ta,mahasiswa.nim, id_mhs, mahasiswa.nama AS name, judul, dosen.nama ,ta.tema from ta, mahasiswa,dosen WHERE ta.id_mhs=mahasiswa.nim AND ta.id_dosbing = dosen.nidn";
                              ...
                              while ($row = mysqli_fetch_array($result))
                              {
                                  ...
                                  <tr>
                                      ...
                                      <td class="text-table">
                                          <!-- <a href="action/edit_ta.php?nim=<?php echo $row['nim']; ?>&nama=<?php echo $row['name']; ?>&judul=<?php echo $row['judul'];?>&dosbing=<?php echo $row['nama']; ?>&tema=<?php echo $row['tema']; ?>&id_ta=<?php echo $row['id_ta']; ?>" title="">
                                              <i class="fa fa-edit"></i>
                                          </a> -->
                                          <a href="./action/aksi_edit_ta.php?id_ta=<?php echo $row['id_ta']; ?>&aksi=delete" title="">
