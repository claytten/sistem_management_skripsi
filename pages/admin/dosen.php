...
<head>
    ...
    <title>List Management Account Dosen</title>
                            ...
                            <?php
                              ...
                              while ($row = mysqli_fetch_array($result))
                              {
                                  ...
                                  <tr>
                                      ...
                                      <td class="text-table">
                                          <a href="./action/edit_dosen.php?nama=<?php echo $row['nama']; ?>&nidn=<?php echo $row['nidn']; ?>&nama_tema=<?php echo $row['nama_tema']; ?>" title="">
                                              <i class="fa fa-edit"></i>
                                          </a>
                                          <a href="./action/aksi_edit_dosen.php?nidn=<?php echo $row['nidn']; ?>&aksi=delete" title="">
