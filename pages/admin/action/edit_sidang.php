...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <form class="needs-validation" novalidate action="./aksi_edit_sidang.php" method="post">
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">Nilai</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="Nilai"  name="nilai" value="<?php echo $nilai; ?>" required>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Tanggal Sidang Akhir</label>
