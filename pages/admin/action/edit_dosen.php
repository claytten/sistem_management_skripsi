...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="../user.php">User</a></li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <form class="needs-validation" novalidate action="./aksi_edit_dosen.php" method="post">
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">NIDN</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="NIM/NIDN"  name="nidn" value="<?php echo $nidn?>" required="required" autofocus="autofocus" readonly>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" name="nama" value="<?php echo $nama?>" required>
                ...
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">Nama Tema</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="Password"  name="tema" value="<?php echo $nama_tema?>" required>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
