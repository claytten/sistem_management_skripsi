...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <form class="needs-validation" novalidate action="./aksi_edit_mahasiswa.php" method="post">
              <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" name="username" value="<?php echo $username?>" required>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="password" class="form-control" id="validationTooltip01" placeholder="Password"  name="password" value="<?php echo $password?>" required>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
