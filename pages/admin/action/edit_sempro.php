...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <form class="needs-validation" novalidate action="./aksi_edit_sempro.php" method="post">
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">Name</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="Full Name" name="nama" value="<?php echo $nama_mhs?>"required="required" autofocus="autofocus" readonly>
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="Tema"  name="tema" value="<?php echo $tema?>" required="required" autofocus="autofocus" readonly>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Dosen Pembimbing" name="pembimbing" value="<?php echo $nama_dosbing?>" required="required" autofocus="autofocus" readonly>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                    <label for="exampleInputPassword1">Idx</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" value="<?php echo $idx?>" name ="idx" required="required" autofocus="autofocus" readonly>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                    <label for="exampleInputPassword1">id dosbing</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" value="<?php echo $id_dosbing?>" name ="id_dosbing" required="required" autofocus="autofocus" readonly>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                    <label for="exampleInputPassword1">Judul</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" value="<?php echo $judul?>" name ="id_ta" required="required" autofocus="autofocus" readonly>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Tanggal Seminal Proposal</label>
