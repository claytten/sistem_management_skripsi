...
<body>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Register Mahasiswa/Dosen</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-3">
            <form class="needs-validation" action="action/aksi_register.php" method="post">
              <div class="form-row">
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">Name</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="Full Name" name="nama" required>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">NIM/NIDN</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="NIM/NIDN"  name="nim_nidn" required>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="validationTooltipUsername" placeholder="Username" aria-describedby="validationTooltipUsernamePrepend" name="username" required>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <label for="validationTooltip01">Tema</label>
                  <input type="text" class="form-control" id="validationTooltip01" placeholder="Tema"  name="tema" required>
                  <div class="valid-tooltip">
                    Looks good!
                  </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="role" id="status" required>
                            <option value="" selected hidden disabled>Pilih status</option>
                            <option id="cek"value="dosen">Dosen</option>
                            <option id="cek" value="mahasiswa">Mahasiswa</option>
                        </select>
                      </div>
                </div>  
              </div>
              <input type="submit" name="" class="btn btn-primary" value="Submit Form">
            </form>
