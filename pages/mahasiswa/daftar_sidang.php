    ...
    <article id="bidang">
      <div class="container">
        <header class="section-header">
          <h3 class="section-title">Formulir Sidang Akhir<br><?php echo $_SESSION['name']; ?></h3>
        </header>
        <section id="contact" class="section-bg wow fadeInUp">
          <div class="container">
            <div class="form">
              <form action="action/aksi_daftar_sidang.php" method="post">
                <div class="form-row">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <input type="text" name="id_dosuji" class="form-control" id="name" placeholder="NIDN Dosen Penguji" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" name="tema" class="form-control" id="name" placeholder="Judul" data-rule="minlen:4" data-msg="Please enter at least 4 chars" value="<?php echo mysqli_fetch_array(mysqli_query($connect, "SELECT tema from ta where ta.id_mhs = '$nim'"))[0];?>" required readonly/>
                  </div>
                </div>
                <div class="form-group">
                    <select class="form-control" name="ruang_sidang" required>
